<div class="favourites index">
	...
	<tr>
		...
		<td><?php echo h($favourite['Favourite']['created']); ?>&nbsp;</td>
		<td><?php echo h($favourite['Favourite']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $favourite['Favourite']['id']), array(), __('Are you sure you want to delete # %s?', $favourite['Favourite']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
